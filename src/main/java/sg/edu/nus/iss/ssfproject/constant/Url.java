...
public class Url {
    ...
    public static final String animesByQuery = "https://api.jikan.moe/v4/anime?q=%s&limit=10&sfw=true";
    public static final String animeById = "https://api.jikan.moe/v4/anime/%sr";
